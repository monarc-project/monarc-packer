...
sudo apt-get -y install apache2 libapache2-mod-php php7.4-curl php7.4-gd php7.4-mysql php-apcu php-xml php7.4-mbstring php7.4-intl php-imagick php7.4-zip php7.4-bcmath > /dev/null
